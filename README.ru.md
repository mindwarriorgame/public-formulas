# MindWarrior игра: примеры Формулы

Личные [Формулы Твердой Решимости](https://mindwarriorgame.org/faq.ru.html#formula), которые некоторые игроки решились опубликовали для всех в качестве примера.

Все публичные Формулы собираются и публикуются на нашем сайте https://mindwarriorgame.org для примера, чтобы вдохновлять других игроков.

# Большое спасибо!

Большое спасибо за вашу помощь! Пример сильной, работающей Формулой в качестве примера может оказаться хорошим подспорьем для кого-то, кто следует своим собственным целям и стремлениям 🙌.

## Требования к Формуле

Чтобы ваша Формула была принята в этот репозиторий, она должна соответствовать следующим требованиям:

1. Содержание должно быть уважительным и конструктивным, без оскорблений, личных нападок или дискриминационного языка.
2. Формула не должна включать неподобающее содержание, такое как сексуальные материалы, угрозы насилием или что-либо, нарушающее закон.
3. Спам, реклама или продвижение других продуктов/услуг запрещены.
4. Избегайте чрезмерной ненормативной лексики или оскорбительных выражений.
5. Формула должна быть написана ясно и понятно.
...
По умолчанию все опубликованные Формулы переводятся на недостающие языки с помощью ChatGPT. Если хотите, вы можете добавить свой личный перевод (также добавьте его в Issue).
...
Поскольку вы предоставляете ваш `shared_key_uuid`, хотя он не содержит никакой личной информации о вас (это случайная строка), это может вызвать тревогу по поводу конфиденциальности. Чтобы решить этот вопрос, вы всегда можете сгенерировать новый `shared_key_uuid` для вашего игрового аккаунта, отправив команду `regenerate_shared_key_uuid` боту. Это удалит логическую связь между опубликованной Формулой и вашим игровым аккаунтом.
...
Обратите внимание, что работа над проектом с открытым исходном коде в GitHub-а сохранит историю всех модификаций репозитория. В контексте вашей Формулы, это создаст постоянную связь между вашем аккаунтом GitHub и опубликованной Формулой.

Несмотря на то, что существуют разные стратегии для обхода этого обстоятельства (например, использование анонимайзеров, таких как https://www.gitmask.com/ или создание временных аккаунтов), они все поднимают собственные вопросам конфиденциальности. (Кроме того, если мы не сможем идентифицировать вас как начального автора, вы не сможете вносить значительные правки к своей Формуле в будущем.) Пожалуйста, обратите на это внимание.

## Лицензия

Все содержимое этого репозитория публикуется под [лицензии MIT](https://ru.wikipedia.org/wiki/MIT_License). Все, что вы пишете в issue или PR, включая вашу Формулу, становится неотъемлемой частью (код, документации) этого публичного проекта с открытым исходным кодом. То есть, согласно лицензии, вы даёте всем разрешение использовать, копировать, модифицировать, объединять, публиковать, распространять, выдавать лицензии и продавать копии вашей Формулы и т.д. Пожалуйста, убедитесь, что хорошо осознаете это перед тем, как вы опубликуете вашу Формулу!
