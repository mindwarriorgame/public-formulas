...
Обратите внимание, что при работе над проектами с открытым исходном кодом (включая и этот проект), GitHub сохраняет всю историю модификаций репозитория. В контексте вашей Формулы, это создаст постоянную связь между вашем аккаунтом GitHub и опубликованной Формулой.
